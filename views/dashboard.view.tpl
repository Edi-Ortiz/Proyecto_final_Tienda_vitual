...
<section class="infod">
  <p>Revisa nuestro catálogo de lo mejor en moda de alta calidad.</p>
  <p id="p2">Podras revisar aqui tus prendas preferidass</p>
</section>
...
<section class="row"> 
  ...
  <div class="modal">
    ...
    <div class="modal__details">
      <h1 class="modal__title">TIENDAX</h1>
      <p class="modal__description">Buena Eleccion</p>
    </div>
    <p class="modal__text">¿Desea agregarlo a favoritos?</p>
...
<style>
 ...
 .sec_galeria h2{
  ...
  font-size: 1.7rem;
	margin: 1em 1em;
	padding: 8px;
	background-color: #f700ffa2;
	box-shadow: -5px 5px 1px #ff00ea;

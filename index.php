...
// Desde aqui son los de la perfumeria
case "index":
    include_once "controllers/webshop/index.control.php";
    die();
case "nosotros":
      include_once "controllers/webshop/nosotros.control.php";
      die();
case "mujeres":
        include_once "controllers/webshop/mujeres.control.php";
        die();
case "hombres":
          include_once "controllers/webshop/hombres.control.php";
          die();
case "servicios":
            include_once "controllers/webshop/servicios.control.php";
            die();


//servicios
case "oficina":
  include_once "controllers/webshop/servicios/oficina.control.php";
  die();
case "actividades":
    include_once "controllers/webshop/servicios/actividades.control.php";
    die();

//mujeres
case "infantiles":
  include_once "controllers/webshop/mujeres/infantiles.control.php";
  die();
case "juvenil":
  include_once "controllers/webshop/mujeres/juvenil.control.php";
  die();
case "familiar":
  include_once "controllers/webshop/mujeres/familiar.control.php";
  die();
